...
describe LinkedDataFragments::Result do
  ...
  describe '#type' do
    it "should be a hydra collection" do
      expect(subject.type)
        .to include RDF::URI('http://www.w3.org/ns/hydra/core#Collection')
    end

    it "should be a paged collection" do
      expect(subject.type)
        .to include RDF::URI('http://www.w3.org/ns/hydra/core#PagedCollection')
    end
  end
